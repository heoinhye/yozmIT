...
UserRecord를 사용하면 Getter, 생성자, equals(), hashCode(), toString() 메서드를 일일이 작성할 필요가 없습니다. Record는 불변 객체를 간단하고 깔끔하게 만들 수 있는 방법을 제공합니다.
...
- 반면, Record는 내부적으로 필드만 가지고 필요한 메서드를 자동으로 생성하므로, 더 적은 자원을 사용할 가능성이 있습니다.
